...
@Component({
    selector: 'ngx-cadastrar-templates',
    styleUrls: ['./cadastrar-templates.scss'],
    templateUrl: './cadastrar-templates.html',
})
export class CadastrarTemplatesComponent {
    ...
    cadastrar(data){
        ...
        this.router.navigateByUrl('/configurar-agenda/configurar-templates/', { state: data });
